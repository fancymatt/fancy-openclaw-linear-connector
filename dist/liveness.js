 ...
 */
export async function checkAgentLiveness(agentName, config) {
...
// ── Hooks mode ──────────────────────────────────────────────────────────────
async function checkHooksLiveness(agentName, hooksUrl, hooksToken, timeoutMs) {
    try {
 ...
 */
async function checkCliLiveness(agentName) {
